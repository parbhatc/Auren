...
const SYNC_FILES = [
  ...
  'server/src/services/PracticeService.js',
  ...
  'server/src/utils/practiceTradePnl.js',
  'server/src/utils/practiceInstrumentTicks.js',
  'server/test/practiceMarketDataWebSocket.test.js',
  'server/test/backtesterDataWebSocket.test.js',
  'server/test/practiceInstrumentTicks.test.js',
  'server/test/practiceTradePnl.test.js',
  'src/propfirms/tradesea/TradeseaPropFirm.ts',
  'src/App.tsx',
  'src/components/common/ProtectedRoute.tsx',
  'src/components/admin/site_settings/Renderer.tsx',
  'src/components/layout/ProductHeader.tsx',
  'src/components/trading/shared/pad/TradePanel.tsx',
  'src/pages/workspace/WorkspacePages.tsx',
  'src/pages/admin/AdminWorkspacePage.tsx',
  'src/services/practice/PracticeMarketDatafeed.ts',
  'src/services/practice/practiceInstrumentTicks.ts',
