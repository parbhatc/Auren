...
type PlaybookCondition = {
  id: string
  label: string
  type: 'boolean' | 'time' | 'timeframe' | 'timeframe_time' | 'liquidity_sweep' | 'pda_delivery' | 'text' | 'number'
}
...
function normalizePlaybookCondition(value: unknown, index: number): PlaybookCondition {
  if (value && typeof value === 'object') {
    ...
    const validTypes: PlaybookCondition['type'][] = ['boolean', 'time', 'timeframe', 'timeframe_time', 'liquidity_sweep', 'pda_delivery', 'text', 'number']
