...
export default function AccountDetailModal({
  ...
  const chartLabel =
    getPracticeMarketDataSettings().accountLabel || account.marketDataAccountLabel || '—'
        ...
        <DetailSection title="Performance" isDark={isDark}>
          <div className="grid grid-cols-2 gap-2">
            ...
            <StatCard
              ...
              accent={pnlAccent}
            />
            <StatCard label="Trades" value={totalTrades != null ? String(totalTrades) : '…'} isDark={isDark} />
