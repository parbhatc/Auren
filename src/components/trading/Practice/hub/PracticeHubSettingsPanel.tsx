...
import SettingsWrapper from '../../../settings/Settings/SettingsWrapper'
import PropsSettingsWrapper from '../../../settings/PropsSettings/PropsSettingsWrapper'
import UtilsSettingsWrapper from '../../../settings/UtilsSettings/UtilsSettingsWrapper'
import KeyboardShortcutsSettingsWrapper from '../../../settings/KeyboardShortcutsSettings/KeyboardShortcutsSettingsWrapper'
...
function SectionContent({
  ...
  switch (section) {
    case 'account':
      return <SettingsWrapper embedded onBack={onBack} />
    case 'market':
      return <PropsSettingsWrapper embedded onBack={onBack} />
    case 'shortcuts':
      return <KeyboardShortcutsSettingsWrapper embedded onBack={onBack} />
    case 'utils':
      return <UtilsSettingsWrapper embedded onBack={onBack} />
  }
}

export default function PracticeHubSettingsPanel({ isDark }: { isDark: boolean }) {
