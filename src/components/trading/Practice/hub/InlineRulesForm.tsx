...
import type {
  InlineRulesFormHandle,
  InlineRulesFormProps,
} from '../../../../types/practiceHub'

export type { InlineRulesFormHandle, PracticeInlineRulesFormHandle } from '../../../../types/practiceHub'
...
const InlineRulesForm = forwardRef<InlineRulesFormHandle, InlineRulesFormProps>(function InlineRulesForm(
...
export default InlineRulesForm

/** @deprecated use InlineRulesForm */
export const PracticeInlineRulesForm = InlineRulesForm
