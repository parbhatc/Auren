...
import InlineRulesForm, {
  type InlineRulesFormHandle,
} from './InlineRulesForm'
import HubModal from './HubModal'

type HubConfirm = 'create' | 'reset' | 'delete' | 'resetAll' | null

export default function HubConfirmDialogs({
  confirm,
  isDark,
  newMode,
  newSize,
  ...
  const rulesFormRef = useRef<InlineRulesFormHandle>(null)
