...
import PracticeBlownAccountModal from './PracticeBlownAccountModal'
import PracticePassedAccountModal from './PracticePassedAccountModal'

class PracticeTrade extends Component {
  render() {
    return <PracticeTradeWrapperInner />
  }
}

function PracticeTradeWrapperInner() {
