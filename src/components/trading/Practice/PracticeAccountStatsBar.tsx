export function formatPracticeStatMoney(
  value: number,
...
export function PracticeAccountStatsBar({
  isDark,
  balance,
  rpl,
  upl,
  ...
  const rplFmt = formatPracticeStatMoney(rpl, { decimals: 2 })
  const uplFmt = formatPracticeStatMoney(upl, {
