...
import { PadCheckbox, BracketPriceTicksRow, TickPresetChips } from '../PracticePadControls'
import type {
...
export function PracticeOrderTab({
  props,
  maxQty,
  book,
  marketPrice,
  ...
  const handleConfirm = () => {
    ...
    const brackets: PracticeBracketOptions = {
    ...
    const orderOpts: PracticeOrderSubmitOptions = {
      orderType,
      ...
      <div className="flex flex-col gap-3 flex-1 min-h-0 overflow-y-auto py-1 pb-36 scrollbar-hide">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className={`flex flex-col items-start gap-0.5 rounded-2xl border px-3 py-2.5 text-left transition ${
              selectedSide === 'buy'
                ? 'border-[#3fb950] bg-[#238636]/25 shadow-[inset_0_0_0_1px_rgba(63,185,80,0.25)]'
                : 'border-[#238636]/35 bg-[#238636]/8 hover:bg-[#238636]/14'
            }`}
          >
            <span className="text-xs font-bold uppercase tracking-wide text-[#3fb950]">Buy</span>
          ...
          <button
            ...
            className={`flex flex-col items-start gap-0.5 rounded-2xl border px-3 py-2.5 text-left transition ${
              selectedSide === 'sell'
                ? 'border-[#f85149] bg-[#da3633]/25 shadow-[inset_0_0_0_1px_rgba(248,81,73,0.25)]'
                : 'border-[#da3633]/35 bg-[#da3633]/8 hover:bg-[#da3633]/14'
            }`}
          >
            <span className="text-xs font-bold uppercase tracking-wide text-[#f85149]">Sell</span>
            <span className="text-[11px] text-[#7d8590]">
              Ask{' '}
              <span className="font-mono text-sm text-[#e6edf3] tabular-nums">
      ...
      <div className="sticky bottom-0 shrink-0 pt-2 pb-3 mt-auto border-t border-[#334155] bg-gradient-to-t from-[#0f172a] via-[#0f172a] to-[#0f172a]/95">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className={`flex-[1.4] py-2.5 px-3 rounded-2xl border font-semibold text-sm text-white transition disabled:opacity-50 ${
              selectedSide === 'buy'
                ? 'border-[#3fb950]/40 bg-[#238636] hover:bg-[#2ea043]'
                : 'border-[#f85149]/40 bg-[#da3633] hover:bg-[#f03e3e]'
            }`}
          >
