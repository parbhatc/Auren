...
import PracticeHubNav, { type PracticeHubTab } from './hub/PracticeHubNav'
import PracticeHubStatsBar from './hub/PracticeHubStatsBar'
import PracticeHubSettingsPanel from './hub/PracticeHubSettingsPanel'
import PracticeMarketDataSection from './hub/PracticeMarketDataSection'
import PracticeNewAccountSection from './hub/PracticeNewAccountSection'
import PracticeAccountsList from './hub/PracticeAccountsList'
import PracticeHubConfirmDialogs from './hub/PracticeHubConfirmDialogs'
import PracticeAccountDetailModal from './hub/PracticeAccountDetailModal'

type HubConfirm = 'create' | 'reset' | 'delete' | 'resetAll' | null

function parseTab(value: string | null): PracticeHubTab {
...
export default function PracticeHub() {
  ...
  const setActiveTab = (tab: PracticeHubTab) => {
    if (tab === 'accounts') {
      setSearchParams({})
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        {loadingHub ? (
          ...
          <>
            ...
            {activeTab === 'settings' && <PracticeHubSettingsPanel isDark={isDark} />}
          </>
        )}
      </main>

      <PracticeHubConfirmDialogs
        confirm={confirm}
        isDark={isDark}
        newMode={newMode}
        newSize={newSize}
