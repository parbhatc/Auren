export { default as HubPage } from '../../Practice/Hub'
export { default as TradePage } from '../../Practice/TradePage'
export { default as StatsPage } from '../../Practice/StatsPage'
export { default as NewsPage } from '../../Practice/NewsPage'
