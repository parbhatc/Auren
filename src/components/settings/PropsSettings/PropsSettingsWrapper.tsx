...
import PropsSettingsRenderer from './PropsSettingsRenderer'
...
export default function PropsSettingsWrapper({ embedded, onBack }: PropsSettingsWrapperProps = {}) {
